...
// Ensure bookings table has event_id column
$res = $conn->query("SHOW COLUMNS FROM bookings LIKE 'event_id'");
if ($res->num_rows == 0) {
    echo "Adding column event_id to bookings...\n";
    $conn->query("ALTER TABLE bookings ADD COLUMN event_id INT NULL AFTER ud_id");
}
