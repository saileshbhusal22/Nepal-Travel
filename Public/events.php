        ...
        <div id="formScrollContainer" style="flex: 1.2; padding: 50px; border-right: 1px solid #eee; background: #fff; overflow-y: auto; max-height: 90vh;">
            ...
            <form id="addEventForm" enctype="multipart/form-data">
                ...
                <div class="form-section" data-section="2">
                    ...
                    <div style="margin-bottom: 25px;">
                        <label style="display: block; font-size: 11px; font-weight: 800; color: #999; margin-bottom: 8px;">COVER IMAGE OR GIF *</label>
                    ...
                    <div>
                        ...
                        <p style="font-size: 10px; color: #999; margin-top: 10px;">Select up to 5 additional images for your event gallery.</p>
                    </div>
                </div>
...
<div id="subscriptionModal" class="search-overlay" style="background: rgba(13, 27, 42, 0.95); padding: 40px; align-items: center;">
    <div class="container" style="max-width: 500px; background: white; border-radius: 24px; padding: 40px; text-align: center;">
        <div style="font-size: 50px; margin-bottom: 20px;">🗓️</div>
        <h2 style="font-family: 'Playfair Display', serif; margin-bottom: 15px;">List Your Event</h2>
        <p style="color: #666; margin-bottom: 30px; font-size: 14px; line-height: 1.6;">Join Nepal's premier travel calendar. Reach thousands of travelers and locals by upgrading to a contributor account.</p>
        <button id="simulateSubscribeBtn" class="premium-btn" style="width: 100%; border: none; background: #285da1; font-weight: 800; letter-spacing: 1px;">SUBSCRIBE NOW ($5/mo)</button>
        <p style="font-size: 11px; color: #999; margin-top: 20px;">* Subscription allows you to post unlimited public events.</p>
    </div>
</div>
