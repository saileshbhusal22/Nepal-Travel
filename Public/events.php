...
<section id="full-calendar" style="padding: 80px 0; background: #fff; font-family: 'Montserrat', sans-serif;">
    <div class="container" style="max-width: 1300px; display: grid; grid-template-columns: 280px 1fr; gap: 50px; align-items: start;">
        ...
        <aside class="events-sidebar" style="position: sticky; top: 120px;">
            ...
            <button style="margin-top: 30px; width: 100%; padding: 14px; background: #111; color: white; border: none; border-radius: 6px; font-weight: 700; letter-spacing: 1px; cursor: pointer;">APPLY FILTERS</button>
        </aside>
        ...
        <main class="events-main">
            ...
            <div style="display: flex; gap: 25px; border-bottom: 1px solid #e0e0e0; margin-bottom: 40px; overflow-x: auto; padding-bottom: 0;">
                ...
                foreach($months as $m) {
                    ...
                    echo "<div style='padding: 0 5px 15px; cursor: pointer; text-transform: uppercase; font-size: 14px; transition: all 0.2s; $colorStr $borderStr'>$m</div>";
                }
                ?>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 30px;">
                ...
                <?php 
                $events = [
                    ['img' => '../images/chitwan_rhino.png', 'badge' => 'FESTIVAL', 'badge_color' => '#6bb33b', 'title' => 'Buddha Jayanti Celebration', 'desc' => 'Join the grand spiritual celebration at the birthplace of Lord Buddha.', 'date' => '12 MAY 2026'],
                    ['img' => '../images/pokhara_lake.png', 'badge' => 'SPORTS', 'badge_color' => '#285da1', 'title' => 'Phewa Lake Regatta', 'desc' => 'An exciting week of watersports and competitive boating over the pristine lake.', 'date' => '14 - 18 MAY 2026'],
                    ['img' => '../images/bhaktapur_temple.png', 'badge' => 'ARTS & CULTURE', 'badge_color' => '#cc3333', 'title' => 'Bhaktapur Pottery Expo', 'desc' => 'Witness master artisans crafting the finest terracotta pottery live.', 'date' => '20 MAY 2026'],
                    ['img' => '../images/annapurna_trek.png', 'badge' => 'NATURE', 'badge_color' => '#5a3ba1', 'title' => 'Annapurna Spring Marathon', 'desc' => 'High-altitude endurance race trails crossing massive suspension bridges.', 'date' => '25 MAY 2026'],
                    ['img' => '../images/food_drinks_nepal.png', 'badge' => 'FESTIVAL', 'badge_color' => '#6bb33b', 'title' => 'Kathmandu Momo Fiesta', 'desc' => 'Taste over 50 varieties of traditional dumplings across Thamel.', 'date' => '28 - 30 MAY 2026'],
                    ['img' => '../images/family_fun_nepal.png', 'badge' => 'ARTS & CULTURE', 'badge_color' => '#cc3333', 'title' => 'Patan Puppet Carnival', 'desc' => 'A magical evening of traditional string puppetry for the whole family.', 'date' => '31 MAY 2026']
                ];
                
                foreach($events as $e):
                ?>
                <div style="border-radius: 16px; overflow: hidden; background: white; border: 1px solid #f0f0f0; display: flex; flex-direction: column; transition: transform 0.3s ease, box-shadow 0.3s ease; box-shadow: 0 4px 15px rgba(0,0,0,0.03);" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 15px 35px rgba(0,0,0,0.08)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(0,0,0,0.03)';">
