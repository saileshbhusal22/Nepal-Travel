...
// ── 5. Find the Pending Booking in Database ──
$safe_uuid = $conn->real_escape_string($decoded['transaction_uuid']);
$booking_row = $conn->query("
    SELECT b.*, u.email, u.full_name
    FROM bookings b
    JOIN users u ON u.id = b.user_id
    WHERE b.payment_ref = '$safe_uuid'
